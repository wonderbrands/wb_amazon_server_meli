...
def crea_tabla_notify_linio():
	...
	CREATE TABLE notify_linio (
		...
		'''
	cursor.execute(sql)
	print "Se ha creado la tabla de notificaciones para Linio."

if __name__ == '__main__':
	crea_tabla_notify_linio()