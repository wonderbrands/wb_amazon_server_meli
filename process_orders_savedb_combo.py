...
url_sr ='https://somosreyes-test-512635.dev.odoo.com'
...
def procesa_pedido_normal(orden):
	try:
		if orden:
...
def procesa_pedido_carrito(orden):
	try:
		if orden:
			order_status = orden['order_status']
			shipment_status = orden['shipment']['status']
