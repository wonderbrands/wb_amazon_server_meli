...
class RestAPI:
	...
	def productos_en_odoo12(self, sku):
		try:
			lista_productos_odoo_12=[]
			...
			for producto in response:
				...
				print(seller_sku,',',stock_amazon,',',stock_linio,',',stock_prestashop,',',stock_claroshop,',',stock_mercadolibre)
...
if __name__ == '__main__':
	archivo=open('productos_odoo_1.csv', 'r')
	for producto in archivo:
		sku = producto[:-1]
		api.productos_en_odoo12(sku)

	'''
	seller_sku='18LINOX-URTEC'
	stock_quant_ids = get_stock_quant_ids(seller_sku)
